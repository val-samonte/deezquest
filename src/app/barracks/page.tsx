...
export default function Barracks() {
  ...
  return (
    <div className='flex w-full'>
      ...
      >
        <div className='portrait:w-screen flex-auto overflow-y-auto overflow-x-hidden p-3 xl:p-5'>
      ...
      <div
        className={classNames(
          open ? 'w-screen sm:w-1/3 xl:w-1/4' : 'w-0',
...
// />
//         </div>
//         <div className='flex-none w-screen sm:w-[30vw] xl:max-w-md bg-black/50 h-14 xl:h-16 '>
// <button
//   type='button'
//   className='mr-3 md:mr-5 flex items-center'
//   onClick={() => setOpen(false)}
